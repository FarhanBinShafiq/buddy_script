...
import DynamicPostItem from './components/PostItem/DynamicPostItem';
    ...
    fetch(`${import.meta.env.VITE_API_URL}/api/posts`, {
      ...
      .then(data => {
        if (Array.isArray(data)) {
          ...
          console.warn("Unexpected response format for posts:", data);
        }
      })
      .catch(err => {
            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div className="_layout_middle_wrap">
                  ...
                  {/* Render dynamic posts first */}
                  {posts.map(post => (
                    <DynamicPostItem key={post._id} post={post} onPostUpdated={fetchPosts} />
                  ))}

                  {/* Render original hardcoded mock posts exactly */}
                  <PostItem />
                </div>
              </div>
