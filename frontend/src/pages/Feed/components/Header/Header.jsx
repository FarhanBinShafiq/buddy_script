...
const Header = () => {
	...
	const user = JSON.parse(localStorage.getItem('user')) || { firstName: 'Dylan', lastName: 'Field' };
				...
				<div className="container _custom_container">
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<div className="_header_nav_profile">
							<div className="_header_nav_profile_image" onClick={() => setIsDropdownOpen(!isDropdownOpen)} style={{ cursor: 'pointer' }}>
								<img src="/assets/images/profile.png" alt="Image" className="_nav_profile_img" />
							</div>
							<div className="_header_nav_dropdown">
								<p className="_header_nav_para">{fullName}</p>
								<button id="_profile_drop_show_btn" onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="_header_nav_dropdown_btn _dropdown_toggle" type="button">
							...
							<div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${isDropdownOpen ? 'show' : ''}`}>
