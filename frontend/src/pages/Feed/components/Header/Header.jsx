		...
		<>
			<nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
				<div className="container _custom_container">
					...
					<button className="navbar-toggler bg-light" type="button" dataBsToggle="collapse" dataBsTarget="#navbarSupportedContent" ariaControls="navbarSupportedContent" ariaExpanded="false" ariaLabel="Toggle navigation"> <span className="navbar-toggler-icon"></span>
					</button>
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						<div className="_header_form ms-auto">
							<form className="_header_form_grp">
								...
								<input className="form-control me-2 _inpt1" type="search" placeholder="input search text" ariaLabel="Search" />
							</form>
						</div>
						<ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link_active _header_nav_link" ariaCurrent="page" href="feed.html">
							...
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link" ariaCurrent="page" href="friend-request.html">
							...
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link" ariaCurrent="page" href="chat.html">
